---
title             : "Transient and stable predictions affect motion perception, Exp. 1 - Pre-registration document"
shorttitle        : "Transient and stable predictions affect motion perception, Exp. 1 - Pre-registration document"
...
library("ggplot2")
library("dplyr")
data_frame <- read.csv("../Results/sample_participant.csv");

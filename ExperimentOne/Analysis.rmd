...
vertical_pscv = t.test(vertical_pscvs$UP, vertical_pscvs$DOWN, method = "paired")
```
...
horizontal_pscv = t.test(horizontal_pscvs$ACCELERATING, horizontal_pscvs$DECELERATING, method = "paired")
```
